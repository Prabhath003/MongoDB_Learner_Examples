...
# To calculate the balance of GBP, divide the original balance by the conversion rate
...
print(
    "Account type, original balance in GBP of checking accounts with original balance greater than $1,500.",
